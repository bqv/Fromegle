...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Wed Oct 24 22:01:42 2012
...
SOURCES       = fromegle.cpp moc_selector.cpp
OBJECTS       = fromegle.o \
		moc_selector.o
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/fromegle1.0.0/ && $(COPY_FILE) --parents selector.h .tmp/fromegle1.0.0/ && $(COPY_FILE) --parents fromegle.cpp .tmp/fromegle1.0.0/ && (cd `dirname .tmp/fromegle1.0.0` && $(TAR) fromegle1.0.0.tar fromegle1.0.0 && $(COMPRESS) fromegle1.0.0.tar) && $(MOVE) `dirname .tmp/fromegle1.0.0`/fromegle1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/fromegle1.0.0
...
compiler_moc_header_make_all: moc_selector.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_selector.cpp
moc_selector.cpp: selector.h
	/usr/bin/moc $(DEFINES) $(INCPATH) selector.h -o moc_selector.cpp
...
fromegle.o: fromegle.cpp selector.h
